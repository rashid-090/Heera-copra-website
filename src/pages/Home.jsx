                ...
                <div className='hidden md:grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 md:gap-5 mt-3'>
                    <div className='bg-white text-black p-5 rounded-2xl shadow-lg duration-150 hover:shadow-2xl flex items-center gap-3'>
                        ...
                        <div>
                            ...
                            <p className='text-sm'> Flat rate transparency with no hidden charges.</p>
                        </div>
                    </div>
                    <div className='bg-white text-black p-5 rounded-2xl shadow-lg duration-150 hover:shadow-2xl flex items-center gap-3'>
                        ...
                        <div>
                            ...
                            <p className='text-sm'>Simplifying the entire visa journey from start to finish, so your team can focus on their work.</p>
                        </div>
                    </div>
                    <div className='bg-white text-black p-5 rounded-2xl shadow-lg duration-150 hover:shadow-2xl flex items-center gap-3'>
                        ...
                        <div>
                            ...
                            <p className='text-sm'>Dedicated end-to-end support with real-time status updates.</p>
                        </div>
                    </div>
                    <div className='bg-white text-black p-5 rounded-2xl shadow-lg duration-150 hover:shadow-2xl flex items-center gap-3'>
                       ...
                       <div>
                            ...
                            <p className='text-sm'> Reliable delivery and easy Dubai Business visa processing time.</p>
                       </div>
                    </div>
                    <div className='bg-white text-black p-5 rounded-2xl shadow-lg duration-150 hover:shadow-2xl flex items-center gap-3'>
                       ...
                       <div>
                            ...
                            <p className='text-sm'> Navigating complex visa processes with ease.</p>
                       </div>
                    </div>
                    <div className='bg-white text-black p-5 rounded-2xl shadow-lg duration-150 hover:shadow-2xl flex items-center gap-3'>
                        ...
                        <div>
                            ...
                            <p className='text-sm'>Fast-track visa services for time-sensitive corporate needs.</p>
                        </div>
                    </div>
    ...
    <section className=''>
        <div className='w-11/12 xl:w-10/12 mx-auto py-10 xl:py-20 grid grid-cols-1 xl:grid-cols-2 gap-5 gap-x-20'>
           <div className='h-full flex flex-col gap-3 justify-center'>
                ...
                <p className='text-gray-600 text-sm md:text-base'>Got questions? Find the answers to common inquiries about our visa services and how we can help your business.</p>
           </div>
            <div className=''>
                <Faq/>
            </div>
